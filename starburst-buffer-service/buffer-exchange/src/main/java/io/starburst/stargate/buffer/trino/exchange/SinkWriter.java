...
public class SinkWriter
{
    ...
    private void scheduleWriting(SinkDataPool.PollResult pollResult)
    {
        ...
        currentRequestFuture = dataApi.addDataPages(bufferNodeId, externalExchangeId, partition, taskPartitionId, taskAttemptId, dataPagesIdGenerator.nextId(), dataPages);
