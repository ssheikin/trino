...
public class TestTrinoFsCloudSpoolingStorageOnAzureHierarchical
        extends AbstractTestTrinoFsCloudSpoolingStorageOnAzure
{
    @Override
    protected String account()
    {
        return requireEnv("ABFS_HIERARCHICAL_ACCOUNT");
    }

    @Override
    protected AzureAuth azureAuth()
    {
        return new AzureAuthAccessKey(requireEnv("ABFS_HIERARCHICAL_ACCESS_KEY"));
    }
