        ...
        implements MetastoreLocator
{
    ...
    {
        this(config, hiveAuthenticationConfig, clientFactory, Ticker.systemTicker());
    }

    @VisibleForTesting
    StaticMetastoreLocator(StaticMetastoreConfig config, HiveAuthenticationConfig hiveAuthenticationConfig, ThriftMetastoreClientFactory clientFactory, Ticker ticker)
    {
