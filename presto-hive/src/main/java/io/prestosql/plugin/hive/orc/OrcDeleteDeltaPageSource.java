...
import static io.prestosql.plugin.hive.acid.AcidSchema.ACID_COLUMN_BUCKET;
import static io.prestosql.plugin.hive.acid.AcidSchema.ACID_COLUMN_ORIGINAL_TRANSACTION;
import static io.prestosql.plugin.hive.acid.AcidSchema.ACID_COLUMN_ROW_ID;
