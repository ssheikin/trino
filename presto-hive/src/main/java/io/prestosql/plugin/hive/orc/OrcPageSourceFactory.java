        ...
        implements HivePageSourceFactory
{
    ...
    private static void validateOrcAcidVersion(Path path, OrcReader reader)
    {
        ...
        int writerId = reader.getFooter().getWriterId().orElseThrow(() -> new PrestoException(HIVE_BAD_DATA, "writerId not set in ORC metadata in " + path));
        if (writerId == OrcMetadataWriter.PRESTO_WRITER_ID) {
