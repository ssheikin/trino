...
public interface PostgreSqlMaterializationDao
        extends MaterializationDao
{
    @SqlUpdate(
            ...
            ON CONFLICT (metastore_id, source_catalog, source_schema, source_table)
            DO UPDATE SET
                storage_table_catalog = EXCLUDED.storage_table_catalog,
                storage_table_schema = EXCLUDED.storage_table_schema,
                storage_table_name = EXCLUDED.storage_table_name,
                storage_table_unique_id = EXCLUDED.storage_table_unique_id,
                last_known_fresh_time = EXCLUDED.last_known_fresh_time,
                grace_period_millis = EXCLUDED.grace_period_millis,
                ir_versions = EXCLUDED.ir_versions,
                catalog_ir_versions = EXCLUDED.catalog_ir_versions,
                computation_plan_root = EXCLUDED.computation_plan_root,
