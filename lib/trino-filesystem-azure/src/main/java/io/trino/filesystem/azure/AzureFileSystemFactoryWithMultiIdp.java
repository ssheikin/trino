...
public class AzureFileSystemFactoryWithMultiIdp
        implements TrinoFileSystemFactory
{
    ...
    @Inject
    public AzureFileSystemFactoryWithMultiIdp(@ForMultiIdp TrinoFileSystemFactory delegate, TokenPassThroughConfig tokenPassThroughConfig)
    {
        this.delegate = requireNonNull(delegate, "delegate is null");
        this.idpName = requireNonNull(tokenPassThroughConfig, "tokenPassThroughConfig is null").getIdpName();
    }
