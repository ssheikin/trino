...
public class TestCustomDateTimeJsonFieldDecoder
{
    ...
    public void testInvalidFormatHint()
    {
        DecoderTestColumnHandle columnHandle = new DecoderTestColumnHandle(
                ...
                false,
                false);
        assertThatThrownBy(() -> new JsonRowDecoderFactory(new NoOpJsonPayloadProvider(new JsonMapperProvider().get())).create(TESTING_SESSION, new RowDecoderSpec(JsonRowDecoder.NAME, emptyMap(), ImmutableSet.of(columnHandle))))
