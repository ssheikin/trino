...
public class TestForwardingAuthToLocal
{
    ...
    {
        assertAllMethodsOverridden(AuthToLocal.class, ForwardingAuthToLocal.class);
    }

    @Test
    public void testProperForwardingMethodsAreCalled()
    {
        assertProperForwardingMethodsAreCalled(AuthToLocal.class, authToLocal -> ForwardingAuthToLocal.of(() -> authToLocal));
    }
}
