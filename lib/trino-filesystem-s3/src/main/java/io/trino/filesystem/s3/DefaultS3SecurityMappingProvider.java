...
final class DefaultS3SecurityMappingProvider
        implements S3SecurityMappingProvider
{
    ...
    @Inject
    public DefaultS3SecurityMappingProvider(S3SecurityMappingConfig config, Supplier<S3SecurityMappings> mappingsProvider)
    {
    ...
    public DefaultS3SecurityMappingProvider(
