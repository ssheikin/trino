...
final class HdfsFileSystemLoader
{
            ...
            boolean quietBootstrap)
    {
        ...
        try (var _ = new ThreadContextClassLoader(classLoader)) {
            manager = clazz.getConstructor(Map.class, boolean.class, boolean.class, boolean.class, String.class, OpenTelemetry.class, boolean.class)
                    .newInstance(config, azureEnabled, gcsEnabled, s3Enabled, catalogName, openTelemetry, quietBootstrap);
        }
