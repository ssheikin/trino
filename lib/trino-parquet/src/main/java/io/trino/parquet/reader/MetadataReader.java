...
public final class MetadataReader
{
    ...
    public static ParquetMetadata readFooter(ParquetDataSource dataSource)
            throws IOException
    {
        return readFooter(dataSource, Optional.empty());
    }
            ...
            throws IOException
    {
        ...
        ParquetMetadata parquetMetadata = new ParquetMetadata(fileMetaData, dataSourceId, OptionalInt.of(completeFooterSize), decryptionContext);
