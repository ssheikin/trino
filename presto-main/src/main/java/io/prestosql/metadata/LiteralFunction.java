        ...
        extends SqlScalarFunction
{
    ...
    private static final Set<Class<?>> SUPPORTED_LITERAL_TYPES = ImmutableSet.of(long.class, double.class, Slice.class, boolean.class, LongTimestamp.class, LongTimestampWithTimeZone.class);
