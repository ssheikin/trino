...
import static io.prestosql.SystemSessionProperties.OPTIMIZE_TOP_N_RANKING;
        ...
        extends BasePlanTest
{
    ...
    {
        assertLimitAbovePartitionedWindow(ROW_NUMBER_FUNCTION_NAME, RankingType.ROW_NUMBER);
        assertLimitAbovePartitionedWindow(RANK_FUNCTION_NAME, RankingType.RANK);
    }
