...
public final class CassandraTableId
        implements ConnectorTableId
{
    public static final ConnectorIdVersion VERSION = new ConnectorIdVersion("CassandraTableId", 1);

    private final String schemaName;
    private final String tableName;
    private final long hash;

    public CassandraTableId(SchemaTableName schemaTableName)
    {
        this(schemaTableName.getSchemaName(), schemaTableName.getTableName());
    }

    @JsonCreator
    public CassandraTableId(
            @JsonProperty("schemaName") String schemaName,
            @JsonProperty("tableName") String tableName)
    {
        this.schemaName = requireNonNull(schemaName, "schemaName is null");
        this.tableName = requireNonNull(tableName, "tableName is null");
        this.hash = XxHash64.hash(new SchemaTableName(schemaName, tableName).toString().getBytes(UTF_8));
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof CassandraTableId that)) {
            return false;
        }
