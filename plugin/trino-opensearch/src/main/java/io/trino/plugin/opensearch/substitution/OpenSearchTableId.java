...
public final class OpenSearchTableId
        implements ConnectorTableId
{
    public static final ConnectorIdVersion VERSION = new ConnectorIdVersion("OpenSearchTableId", 1);
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof OpenSearchTableId that)) {
            return false;
        }
