...
public record JdbcColumnId(String name, JdbcTypeHandleDto jdbcTypeHandle, Type type)
        implements ConnectorColumnId
{
    public static final ConnectorIdVersion VERSION = new ConnectorIdVersion("JdbcColumnId", 1);
