...
public interface ResourceGroupsDao
{
    ...
    @SqlQuery("SELECT S.resource_group_id, S.priority, S.user_regex, S.source_regex, S.original_user_regex, S.authenticated_user_regex, S.query_type, S.client_tags, S.selector_resource_estimate, S.user_group_regex, S.query_text_regex\n" +
            "FROM selectors S\n" +
