...
public class TestDbSourceExactMatchSelector
{
    ...
    public void testMatch()
    {
        ...
        assertThat(selector.match(new SelectionCriteria(true, "testuser", ImmutableSet.of(), Optional.of("@test@test_pipeline"), ImmutableSet.of("tag"), EMPTY_RESOURCE_ESTIMATES, Optional.empty(), "select * from table"))).isEqualTo(Optional.empty());
