 ...
 */
package com.starburstdata.trino.plugin.io.functions;
...
import static com.starburstdata.trino.plugin.io.StorageLocations.checkLocationArgument;
...
{
    public static final String SCHEMA_NAME = "io";
