...
final class TestPrometheusPlugin
{
    @Test
    void testGetSecuritySensitivePropertyNames()
    {
        Plugin plugin = new PrometheusPlugin();
        ...
        assertThat(sensitiveProperties).containsExactlyInAnyOrder("non-existent-property", "prometheus.auth.password");
    }
}
