        ...
        implements Comparable<Slice>
{
    ...
    {
        checkPositionIndexes(index, index + 1, this.length);
        index += offset;
        return data[index];
    }
    ...
    {
        checkPositionIndexes(index, index + Shorts.BYTES, this.length);
        index += offset;
    ...
    {
        checkPositionIndexes(index, index + Ints.BYTES, this.length);
        index += offset;
    ...
    {
        checkPositionIndexes(index, index + Longs.BYTES, this.length);
        index += offset;
    ...
    public void getBytes(int index, byte[] destination, int destinationIndex, int length)
    {
        ...
        checkPositionIndexes(destinationIndex,
