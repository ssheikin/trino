 ...
 * until the removal finally takes place.
 */
        ...
        implements SecurityManagerCompatibility
{
    ...
    // Visible for testing
    LegacyStrategy(ReflectiveStrategy.Loader loader)
            throws ClassNotFoundException, NoSuchMethodException
    {
        ...
        // This allows for mocking out the method implementation while still accepting
        // Subject instances as arguments.
    ...
    {
        return (T) ReflectiveStrategy.invokeChecked(doAs, PrivilegedActionException.class, null,
                subject, action);
    }

    @Override
    public <T> T callAs(Subject subject, Callable<T> callable)
