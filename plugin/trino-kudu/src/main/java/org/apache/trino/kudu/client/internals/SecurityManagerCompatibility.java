 ...
 * {@link #doPrivileged(PrivilegedAction)}, {@link #current()}, and
 * {@link #callAs(Subject, Callable)}.
...
{
    /**
     * @return an implementation of this interface which conforms to
     * the functionality available in the current JRE.
     */
