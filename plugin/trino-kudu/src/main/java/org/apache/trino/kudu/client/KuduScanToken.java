        ...
        implements Comparable<KuduScanToken>
{
    ...
    static byte[] serialize(ScanTokenPB message)
            throws IOException
    {
            ...
            throws IOException
    {
        ...
        ToStringHelper helper = toStringHelper("ScanToken")
    ...
    private static KuduScanner.KuduScannerBuilder pbIntoScannerBuilder(
            ScanTokenPB message, KuduClient client)
    ...
    public int hashCode()
    {
        return Objects.hash(tablet, message);
    }
            ...
            extends AbstractKuduScannerBuilder<KuduScanTokenBuilder, List<KuduScanToken>>
    {
        ...
        public List<KuduScanToken> build()
        {
            ...
            ScanTokenPB.Builder proto = ScanTokenPB.newBuilder();
            ...
            if (includeTableMetadata) {
                ...
                if (projectedColumnNames != null) {
                    for (String columnName : projectedColumnNames) {
                        ...
                        checkArgument(columnSchema != null,
            ...
            try {
                ...
                for (KeyRange keyRange : keyRanges) {
                    ScanTokenPB.Builder builder = proto.clone();
