...
import static org.apache.trino.kudu.ColumnSchema.CompressionAlgorithm;
import static org.apache.trino.kudu.ColumnSchema.Encoding;
...
public class AlterTableOptions
{
    ...
    private boolean isAddingRangeWithCustomHashSchema;
                                               ...
                                               RangePartitionBound upperBoundType)
    {
        ...
        checkArgument(lowerBound.getSchema().equals(upperBound.getSchema()));
