...
/**
 * Represents a Kudu Table column. Use {@link ColumnSchemaBuilder} in order to
 * create columns.
 */
...
public class ColumnSchema
{
    ...
    public boolean equals(Object o)
    {
        ...
        return Objects.equals(name, that.name) &&
                ...
                key == that.key &&
                keyUnique == that.keyUnique &&
                autoIncrementing == that.autoIncrementing &&
