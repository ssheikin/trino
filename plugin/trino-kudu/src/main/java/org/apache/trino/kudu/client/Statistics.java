...
{
    private final ConcurrentHashMap<String, TabletStatistics> stsMap =
    ...
    {
        TabletStatistics tabletStats = stsMap.get(tabletId);
        if (tabletStats == null) {
            TabletStatistics newTabletStats = new TabletStatistics(tableName,
                    tabletId);
