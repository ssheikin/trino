...
import org.apache.trino.kudu.client.Statistics.Statistic;
import org.apache.trino.kudu.client.Statistics.TabletStatistics;
        ...
        extends KuduRpc<BatchResponse>
{
    ...
    {
        checkState(Bytes.memcmp(operation.partitionKey(),
