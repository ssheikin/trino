...
public class Status
{
    ...
    {
        checkState(masterErrorPB.hasStatus(), "no status in PB " + masterErrorPB);
    ...
    {
        checkState(tserverErrorPB.hasStatus(), "no status in PB " + tserverErrorPB);
    ...
    {
        checkState(pbError.hasStatus(), "no status in PB " + pbError);
