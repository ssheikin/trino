        ...
        implements Comparable<RemoteTablet>
{
    ...
    {
        checkArgument(replicas.size() == serverInfos.size(),
        ...
        ImmutableList.Builder<LocatedTablet.Replica> replicasBuilder = ImmutableList.builder();
    ...
    public int hashCode()
    {
        return Objects.hash(tableId, partition);
    }
}
