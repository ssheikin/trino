        ...
        implements AutoCloseable
{
     ...
     */
    public boolean isCreateTableDone(String name)
            throws KuduException
    {
     ...
     * (e.g. the table does not exist)
     */
    public boolean isAlterTableDone(String name)
            throws KuduException
    {
        TableIdentifierPB.Builder table = TableIdentifierPB.newBuilder().setTableName(name);
     ...
     * @throws KuduException if anything went wrong
     */
    public ListTabletServersResponse listTabletServers()
            throws KuduException
    {
     ...
     * @throws KuduException if anything went wrong
     */
    public ListTablesResponse getSoftDeletedTablesList()
            throws KuduException
    {
     ...
     * @throws KuduException if anything went wrong
     */
    public ListTablesResponse getSoftDeletedTablesList(String nameFilter)
            throws KuduException
    {
     ...
     * @throws KuduException if anything went wrong
     */
    public KuduTableStatistics getTableStatistics(String name)
            throws KuduException
    {
     ...
     * @throws KuduException if anything went wrong
     */
    KuduTable openTableById(final String id)
            throws KuduException
    {
    ...
    public KuduTransaction newTransaction()
            throws KuduException
    {
     ...
     */
    @InterfaceAudience.LimitedPrivate("Test")
    public HostAndPort findLeaderMasterServer()
            throws KuduException
    {
        ...
        checkState(!entry.isNonCoveredRange());
    ...
    static <R> R joinAndHandleException(Deferred<R> deferred)
            throws KuduException
    {
        try {
