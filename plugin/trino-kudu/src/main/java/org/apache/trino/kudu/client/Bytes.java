...
import org.apache.kudu.shaded.io.netty.util.CharsetUtil;
...
public final class Bytes
{
    ...
    public static void pretty(final StringBuilder outbuf, final byte[] array)
    {
        ...
        int ascii = 0;
        final int startLength = outbuf.length();
        final int n = array.length;
        outbuf.ensureCapacity(startLength + 1 + n + 1);
        outbuf.append('"');
        for (int i = 0; i < n; i++) {
            ...
            implements Comparator<byte[]>, Serializable
    {
        ...
        private MemCmp()
        {  // Can't instantiate outside of this class.
        }
    ...
    public static void writeByteArray(DataOutput dataOutput, byte[] b)
            throws IOException
    {
    ...
    public static byte[] readByteArray(DataInput dataInput)
            throws IOException
    {
