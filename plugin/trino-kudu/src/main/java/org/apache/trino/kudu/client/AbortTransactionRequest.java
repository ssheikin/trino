...
import static org.apache.kudu.transactions.TxnManager.AbortTransactionResponsePB;

/**
 * A wrapper class for kudu.transactions.TxnManagerService.AbortTransaction RPC.
 */
        ...
        extends KuduRpc<AbortTransactionResponse>
{
    ...
    {
        final AbortTransactionResponsePB.Builder b = AbortTransactionResponsePB.newBuilder();
