...
package org.apache.trino.kudu.util;

import org.apache.trino.kudu.ColumnSchema;
import org.apache.trino.kudu.ColumnSchema.ColumnSchemaBuilder;
import org.apache.trino.kudu.ColumnSchema.CompressionAlgorithm;
import org.apache.trino.kudu.ColumnSchema.Encoding;
import org.apache.trino.kudu.ColumnTypeAttributes;
import org.apache.trino.kudu.Schema;
import org.apache.trino.kudu.Type;
...
import static org.apache.trino.kudu.util.DataGenerator.randomBinary;
import static org.apache.trino.kudu.util.DataGenerator.randomDate;
import static org.apache.trino.kudu.util.DataGenerator.randomDecimal;
import static org.apache.trino.kudu.util.DataGenerator.randomString;
...
public class SchemaGenerator
{
    ...
    public static class SchemaGeneratorBuilder
    {
        ...
        {
            checkArgument(defaultRate >= 0f && defaultRate <= 1f,
        ...
        {
            checkArgument(minPrecision >= DecimalUtil.MIN_DECIMAL_PRECISION,
                    "minPrecision must be greater than or equal to " +
                            DecimalUtil.MIN_DECIMAL_PRECISION);
            checkArgument(maxPrecision <= DecimalUtil.MAX_DECIMAL_PRECISION,
                    "maxPrecision must be less than or equal to " +
                            DecimalUtil.MAX_DECIMAL_PRECISION);
            checkArgument(minPrecision <= maxPrecision,
        ...
        {
            checkArgument(keyColumnCount <= columnCount,
            ...
            checkArgument(!keyTypes.isEmpty(),
