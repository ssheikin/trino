...
import io.trino.plugin.postgresql.rule.RewriteArraySubscript.RewriteArraySubscriptFilter;
import io.trino.plugin.postgresql.rule.RewriteArraySubscript.RewriteArraySubscriptProjection;
        ...
        extends BaseJdbcClient
{
            ...
            RemoteQueryModifier queryModifier)
    {
        ...
        BiFunction<ConnectorSession, JdbcColumnHandle, JdbcTypeHandle> arrayElementTypeHandleProvider = (connectorSession, columnHandle) -> {
