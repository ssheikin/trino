...
public class ReadSessionCreator
{
            ...
            int currentWorkerCount)
    {
        ...
        TableId actualTableId = getActualTableId(session, client, type, tableId, selectedFields, isViewMaterializationWithFilter(session) ? filter : Optional.empty());
            ...
            Optional<String> filter)
    {
        ...
        if (tableType == VIEW || tableType == MATERIALIZED_VIEW) {
            ...
            return client.getCachedTable(session, viewExpiration, tableId, requiredColumns, filter).getTableId();
        }
