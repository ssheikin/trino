...
public record BigQueryColumnId(String name, List<String> dereferenceNames, Type trinoType, StandardSQLTypeName bigqueryType)
        implements ConnectorColumnId
{
    public static final ConnectorIdVersion VERSION = new ConnectorIdVersion("BigQueryColumnId", 1);

    public BigQueryColumnId
    {
