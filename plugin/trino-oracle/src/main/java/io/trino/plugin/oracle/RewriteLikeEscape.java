...
import static io.trino.plugin.oracle.RewriteLike.supportedType;
import static io.trino.spi.expression.StandardFunctions.LIKE_FUNCTION_NAME;
import static io.trino.spi.type.BooleanType.BOOLEAN;
import static java.lang.String.format;

/**
 * Specialized version of {@link io.trino.plugin.jdbc.expression.RewriteLikeEscapeWithCaseSensitivity}
 * with the following modifications:
 * - Restricts the set of supported types
 * - Removes case sensitivity checks since the Oracle driver does not report them
 */
public class RewriteLikeEscape
