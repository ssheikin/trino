        ...
        extends AbstractTestQueryFramework
{
    ...
    public void testVerifyAutoGeneratedSchemas()
    {
        ...
        for (TpchTable<?> table : TPCH_TABLES) {
            ...
            File actualAutoGeneratedRsdFile = Path.of(actualSchemasDirectory, tableName + ".rsd").toFile();
            File expectedAutoGeneratedRsdFile1 = Path.of(EXPECTED_AUTO_GENERATED_SCHEMAS_DIRECTORY, tableName + "1.rsd").toFile();
            File expectedAutoGeneratedRsdFile2 = Path.of(EXPECTED_AUTO_GENERATED_SCHEMAS_DIRECTORY, tableName + "2.rsd").toFile();

            if (table.getTableName().equals(REGION.getTableName())) {
                File expectedAutoGeneratedRsdFile3 = Path.of(EXPECTED_AUTO_GENERATED_SCHEMAS_DIRECTORY, tableName + "3.rsd").toFile();
