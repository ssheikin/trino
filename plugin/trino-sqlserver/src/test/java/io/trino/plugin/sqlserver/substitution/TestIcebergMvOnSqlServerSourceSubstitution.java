 ...
 */
package io.trino.plugin.sqlserver.substitution;
...
public class TestIcebergMvOnSqlServerSourceSubstitution
        extends AbstractIcebergMvSubstitutionTest
{
            ...
            throws Exception
    {
        ...
        try {
            ...
            queryRunner.createCatalog(sourceSchema.getCatalogName(), "sqlserver", ImmutableMap.of(
