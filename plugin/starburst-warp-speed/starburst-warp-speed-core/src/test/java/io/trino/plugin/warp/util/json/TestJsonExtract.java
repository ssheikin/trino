...
import io.trino.plugin.warp.util.json.JsonExtract.JsonExtractor;
import io.trino.plugin.warp.util.json.JsonExtract.ObjectFieldJsonExtractor;
import io.trino.plugin.warp.util.json.JsonExtract.ScalarValueJsonExtractor;
...
// Adapted from io.trino.operator.scalar.TestJsonExtract to avoid dependency on trino-main.
