...
import static io.trino.plugin.warp.storage.flows.FlowsSequencer.STATS_GROUP_NAME;
...
public class VaradaProxiedWarmerTest
{
            ...
            throws IOException
    {
        ...
        TxServiceStats txServiceStats = TxServiceStats.create(STATS_GROUP_NAME);
        ...
        when(metricsManager.get(WARMING_SERVICE_STAT_GROUP)).thenReturn(warmingServiceStats);
        when(metricsManager.get(STATS_GROUP_NAME)).thenReturn(txServiceStats);
