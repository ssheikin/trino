        ...
        extends WarpStatsBase
{
    ...
    @JsonCreator
    public MemoryStats(@JsonProperty("mem_used_bytes") long mem_used_bytes, @JsonProperty("mem_total_bytes") long mem_total_bytes, @JsonProperty("max_mem_alloc_size") long max_mem_alloc_size, @JsonProperty("min_mem_alloc_size") long min_mem_alloc_size)
    {
        this();
    ...
    public MemoryStats()
    {
        super("memory", WarpStatType.Worker);
