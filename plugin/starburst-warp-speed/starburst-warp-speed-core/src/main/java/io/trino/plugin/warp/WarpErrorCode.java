        ...
        implements ErrorCodeSupplier
{
    ...
    WARP_CATALOG_FAILED_TO_LOAD(519, EXTERNAL),
    WARP_MATCH_LUCENE_FAILED(521, EXTERNAL),
    WARP_MATCH_COLLECT_ID_ALLOCATION(522, EXTERNAL),
    WARP_NATIVE_UNRECOVERABLE_MATCH_ERROR(523, EXTERNAL),
    WARP_NATIVE_MATCH_ERROR(524, EXTERNAL),
