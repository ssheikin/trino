...
public final class FlowSequencerStats
        extends WarpStatsBase
{
    ...
    @JsonCreator
    public FlowSequencerStats(@JsonProperty("group") String group, @JsonProperty("flowType") String flowType)
    {
        super(createKey(group, flowType), WarpStatType.Coordinator);
    ...
    public static FlowSequencerStats create(String group, String flowType)
    {
        return new FlowSequencerStats(group, flowType);
    }
    ...
    public void mergeStats(WarpStatsBase warpStatsBase)
    {
        ...
        FlowSequencerStats other = (FlowSequencerStats) warpStatsBase;
