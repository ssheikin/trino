...
public final class DatacompressionStats
        extends WarpStatsBase
{
    ...
    @JsonCreator
    public DatacompressionStats(@JsonProperty("warm_data_stats_compressed_pages") long warm_data_stats_compressed_pages, @JsonProperty("warm_data_stats_raw_pages") long warm_data_stats_raw_pages)
    {
        this();
    ...
    public DatacompressionStats()
    {
        super("datacompression", WarpStatType.Worker);
