        ...
        extends WarpStatsBase
{
    ...
    @JsonCreator
    public RowgroupStats(@JsonProperty("warm_stats_add_row_group") long warm_stats_add_row_group, @JsonProperty("warm_stats_update_row_group") long warm_stats_update_row_group, @JsonProperty("warm_stats_delete_row_group") long warm_stats_delete_row_group, @JsonProperty("query_stats_query_row_group") long query_stats_query_row_group, @JsonProperty("warm_stats_add_warm_up_element") long warm_stats_add_warm_up_element, @JsonProperty("warm_stats_delete_warm_up_element") long warm_stats_delete_warm_up_element)
    {
        this();
    ...
    public RowgroupStats()
    {
        super("rowgroup", WarpStatType.Worker);
