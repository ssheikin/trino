...
public final class FastwarmingStats
        extends WarpStatsBase
{
    ...
    public FastwarmingStats()
    {
        super("fastwarming", WarpStatType.Worker);
