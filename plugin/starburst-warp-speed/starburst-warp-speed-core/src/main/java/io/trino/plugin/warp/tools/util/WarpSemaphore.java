...
public class WarpSemaphore
        extends Semaphore
{
    private static final Logger logger = Logger.get(WarpSemaphore.class);

    private final int maxPermits;

    public WarpSemaphore(int permits)
    {
        super(permits);
        this.maxPermits = permits;
    }

    public WarpSemaphore(int permits, boolean fair)
    {
        super(permits, fair);
        this.maxPermits = permits;
    }
    ...
    private void protectOverflow()
    {
        ...
        while (over > 0) {
            ...
            boolean _ = super.tryAcquire(over);
