...
public final class CollecttimeStats
        extends WarpStatsBase
{
    ...
    @JsonCreator
    public CollecttimeStats(@JsonProperty("collect_time_total") long collect_time_total, @JsonProperty("collect_time_1_open") long collect_time_1_open, @JsonProperty("collect_time_2_collect") long collect_time_2_collect, @JsonProperty("collect_time_2_1_decide_op") long collect_time_2_1_decide_op, @JsonProperty("collect_time_2_2_cache_pages") long collect_time_2_2_cache_pages, @JsonProperty("collect_time_2_3_data") long collect_time_2_3_data, @JsonProperty("collect_time_2_4_done") long collect_time_2_4_done, @JsonProperty("collect_time_3_close") long collect_time_3_close)
    {
        this();
    ...
    public CollecttimeStats()
    {
        super("collecttime", WarpStatType.Worker);
