 ...
 */
package io.trino.plugin.warp.expression.rewrite.worker.varadatolucene;
...
import static io.trino.plugin.warp.expression.rewrite.coordinator.connectortovarada.SupportedFunctions.LTRIM;
import static io.trino.plugin.warp.expression.rewrite.coordinator.connectortovarada.SupportedFunctions.RTRIM;
import static io.trino.plugin.warp.expression.rewrite.coordinator.connectortovarada.SupportedFunctions.SPLIT_PART;
import static io.trino.plugin.warp.expression.rewrite.coordinator.connectortovarada.SupportedFunctions.STRPOS;
import static io.trino.plugin.warp.expression.rewrite.coordinator.connectortovarada.SupportedFunctions.SUBSTR;
import static io.trino.plugin.warp.expression.rewrite.coordinator.connectortovarada.SupportedFunctions.SUBSTRING;
import static io.trino.plugin.warp.expression.rewrite.coordinator.connectortovarada.SupportedFunctions.TRIM;
