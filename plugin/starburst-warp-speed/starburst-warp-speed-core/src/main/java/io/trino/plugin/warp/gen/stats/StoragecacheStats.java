...
public final class StoragecacheStats
        extends WarpStatsBase
{
    ...
    @JsonCreator
    public StoragecacheStats(@JsonProperty("cache_free_slots") long cache_free_slots, @JsonProperty("cache_stats_hit") long cache_stats_hit, @JsonProperty("cache_stats_miss") long cache_stats_miss, @JsonProperty("cache_stats_total") long cache_stats_total)
    {
        this();
    ...
    public StoragecacheStats()
    {
        super("storagecache", WarpStatType.Worker);
