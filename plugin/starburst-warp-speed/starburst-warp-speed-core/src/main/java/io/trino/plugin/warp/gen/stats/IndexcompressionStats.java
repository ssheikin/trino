...
public final class IndexcompressionStats
        extends WarpStatsBase
{
    ...
    public IndexcompressionStats()
    {
        super("indexcompression", WarpStatType.Worker);
