        ...
        extends WarpStatsBase
{
    ...
    @JsonCreator
    public WarmupExportServiceStats(@JsonProperty("group") String group)
    {
    ...
    public static WarmupExportServiceStats create(String group)
    {
        return new WarmupExportServiceStats(group);
    }
