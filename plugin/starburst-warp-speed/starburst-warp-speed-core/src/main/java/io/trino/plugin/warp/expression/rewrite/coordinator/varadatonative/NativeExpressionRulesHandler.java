...
import static io.trino.plugin.warp.expression.rewrite.coordinator.connectortovarada.SupportedFunctions.DAY;
import static io.trino.plugin.warp.expression.rewrite.coordinator.connectortovarada.SupportedFunctions.DAY_OF_MONTH;
import static io.trino.plugin.warp.expression.rewrite.coordinator.connectortovarada.SupportedFunctions.DAY_OF_WEEK;
import static io.trino.plugin.warp.expression.rewrite.coordinator.connectortovarada.SupportedFunctions.DAY_OF_YEAR;
import static io.trino.plugin.warp.expression.rewrite.coordinator.connectortovarada.SupportedFunctions.DOW;
import static io.trino.plugin.warp.expression.rewrite.coordinator.connectortovarada.SupportedFunctions.DOY;
...
import static io.trino.plugin.warp.expression.rewrite.coordinator.connectortovarada.SupportedFunctions.JSON_EXTRACT_SCALAR;
import static io.trino.plugin.warp.expression.rewrite.coordinator.connectortovarada.SupportedFunctions.LOWER;
import static io.trino.plugin.warp.expression.rewrite.coordinator.connectortovarada.SupportedFunctions.UPPER;
import static io.trino.plugin.warp.expression.rewrite.coordinator.connectortovarada.SupportedFunctions.WEEK;
import static io.trino.plugin.warp.expression.rewrite.coordinator.connectortovarada.SupportedFunctions.WEEK_OF_YEAR;
import static io.trino.plugin.warp.expression.rewrite.coordinator.connectortovarada.SupportedFunctions.YEAR_OF_WEEK;
import static io.trino.plugin.warp.expression.rewrite.coordinator.connectortovarada.SupportedFunctions.YOW;
