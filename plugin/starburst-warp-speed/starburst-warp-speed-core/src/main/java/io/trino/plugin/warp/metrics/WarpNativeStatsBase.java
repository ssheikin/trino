...
public abstract class WarpNativeStatsBase
        extends WarpStatsBase
{
    protected final boolean needBuffer;
    protected LongBuffer buffer;

    protected WarpNativeStatsBase(boolean needBuffer, String jmxKey)
    {
    ...
    public abstract void mergeWithBuffer(WarpStatsBase warpStatsBase);
