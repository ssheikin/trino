...
@Singleton
@Path("v1/ext/")
public class WarpExtResource
{
    private static final Logger logger = Logger.get(WarpExtResource.class);

    private final ConnectorTaskExecutor connectorTaskExecutor;

    @Inject
    public WarpExtResource(ConnectorTaskExecutor connectorTaskExecutor)
    {
