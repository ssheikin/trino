...
@Singleton
public class ClusterReadyTaskExecutionIsAllowedSupplier
        implements BooleanSupplier
{
    private final CoordinatorNodeManager coordinatorNodeManager;

    @Inject
    public ClusterReadyTaskExecutionIsAllowedSupplier(CoordinatorNodeManager coordinatorNodeManager)
    {
    ...
    {
        return coordinatorNodeManager.isClusterReady();
    }
}
