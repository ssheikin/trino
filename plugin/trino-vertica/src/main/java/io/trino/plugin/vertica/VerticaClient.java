        ...
        extends BaseJdbcClient
{
    ...
    */
    ...
    private static boolean consistentWithVerticaOrdering(JdbcSortItem jdbcSortItem)
    {
        return switch (jdbcSortItem.column().getJdbcTypeHandle().jdbcType()) {
            case Types.BINARY,
                 ...
                 Types.DOUBLE,
                 Types.FLOAT,
                 Types.REAL -> jdbcSortItem.sortOrder() == ASC_NULLS_LAST || jdbcSortItem.sortOrder() == DESC_NULLS_FIRST;
            case Types.DATE,
                 Types.TIME,
                 ...
                 Types.TINYINT,
                 Types.DECIMAL,
                 Types.NUMERIC -> jdbcSortItem.sortOrder() == ASC_NULLS_FIRST || jdbcSortItem.sortOrder() == DESC_NULLS_LAST;
            default -> false;
        };
    }
}
