...
//                        ImmutableList.of("18000", "19000"),
    ...
    public void testTableWithoutStorageDescriptor()
    {
        ...
        try {
            ...
            assertThatThrownBy(() -> metastore.getTable(HIVE_IDENTITY, table.getSchemaName(), table.getTableName()))
            ...
            glueClient.createTable(new CreateTableRequest()
                    .withDatabaseName(database)
                    .withTableInput(tableInput));
            assertTrue(isIcebergTable(metastore.getTable(HIVE_IDENTITY, table.getSchemaName(), table.getTableName()).orElseThrow()));
            glueClient.deleteTable(deleteTableRequest);
            ...
            glueClient.createTable(new CreateTableRequest()
                    .withDatabaseName(database)
                    .withTableInput(tableInput));
            assertTrue(isDeltaLakeTable(metastore.getTable(HIVE_IDENTITY, table.getSchemaName(), table.getTableName()).orElseThrow()));
        }
        finally {
