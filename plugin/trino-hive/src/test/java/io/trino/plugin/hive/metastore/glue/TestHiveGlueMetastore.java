            ...
            throws Exception
    {
        ...
        try {
            ...
            List<ColumnMetadata> columns = ImmutableList.<ColumnMetadata>builder()
                    .add(new ColumnMetadata("t_string", VarcharType.VARCHAR))
                    .add(new ColumnMetadata(reservedKeywordPartitionColumnName, VarcharType.VARCHAR))
                    .add(new ColumnMetadata(regularColumnPartitionName, BigintType.BIGINT))
                    .build();
            ...
            Optional<List<String>> partitionNames = metastoreClient.getPartitionNamesByFilter(
                    ...
                    TupleDomain.withColumnDomains(ImmutableMap.of(regularColumnPartitionName, Domain.singleValue(BigintType.BIGINT, 2L))));
            assertTrue(partitionNames.isPresent());
            ...
            partitionNames = metastoreClient.getPartitionNamesByFilter(
                    ...
                    tableName.getTableName(),
                    ImmutableList.of(reservedKeywordPartitionColumnName, regularColumnPartitionName),
                    TupleDomain.withColumnDomains(ImmutableMap.of(reservedKeywordPartitionColumnName, Domain.singleValue(VarcharType.VARCHAR, utf8Slice("value1")))));
            assertTrue(partitionNames.isPresent());
