...
public final class HiveTableId
        implements ConnectorTableId
{
    public static final ConnectorIdVersion VERSION = new ConnectorIdVersion("HiveTableId", 1);
    private static final byte[] PATH_SEPARATOR = {0};
            ...
            @JsonProperty("tableName") String tableName)
    {
        ...
        this.hash = new XxHash64()
                .update(schemaName.getBytes(UTF_8))
                .update(PATH_SEPARATOR)
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof HiveTableId that)) {
            return false;
        }
