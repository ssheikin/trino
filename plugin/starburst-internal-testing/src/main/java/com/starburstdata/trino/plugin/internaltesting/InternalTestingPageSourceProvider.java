...
public class InternalTestingPageSourceProvider
        implements ConnectorPageSourceProvider
{
    private final InternalTestingWorkerOOMPageSource pageSource;

    @Inject
    public InternalTestingPageSourceProvider(InternalTestingWorkerOOMPageSource pageSource)
    {
