        ...
        implements TrinoCatalogFactory
{
    ...
    public synchronized TrinoCatalog create(ConnectorIdentity identity)
    {
        ...
        return new TrinoSnowflakeCatalog(icebergSnowflakeCatalog, catalogName, workScheduler, typeManager, fileSystemFactory, fileIoFactory, tableOperationsProvider, snowflakeDatabase);
    }
