...
public final class SystemTableUtil
{
    ...
    public static List<Type> partitionTypes(List<PartitionField> partitionFields, Map<Integer, Type> idToPrimitiveTypeMapping)
    {
        ImmutableList.Builder<Type> partitionTypeBuilder = ImmutableList.builder();
        for (PartitionField partitionField : partitionFields) {
            Type sourceType = idToPrimitiveTypeMapping.get(partitionField.sourceId());
