        ...
        implements IcebergFileSystemFactory
{
    ...
    public TrinoFileSystem create(ConnectorIdentity identity, Map<String, String> fileIoProperties)
    {
        if (vendedCredentialsEnabled) {
            CachedVendedCredentialsProviders cached = uncheckedCacheGet(
                    ...
                    () -> createVendedCredentialsProviders(identity, fileIoProperties));
    ...
    private CachedVendedCredentialsProviders createVendedCredentialsProviders(ConnectorIdentity identity, Map<String, String> fileIoProperties)
    {
