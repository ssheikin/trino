...
public class TestIcebergTimeZoneAvroTest
        extends BaseIcebergTimeZoneTest
{
    public TestIcebergTimeZoneAvroTest()
    {
        super(AVRO);
    }
    ...
    protected void writeVariantDataToIcebergTable(String outputFilePath, DataFiles.Builder fileBuilder, Table table, Variant... variantValues)
            throws IOException
    {
        writeAvroDataToIcebergTable(outputFilePath, variantValues[0], fileBuilder, table);
    }
