...
import io.trino.plugin.iceberg.TestingFileMetastoreKeyManagementClient;
...
final class TestIcebergParquetEncryption
        extends AbstractTestQueryFramework
{
    ...
    @Test
    void testReadEncryptedParquetTableWithPositionDeletes()
            throws Exception
    {
        ...
        try {
            ...
            DeleteFile posDeleteFile = writeEncryptedPositionDeleteFile(table, encryptionManager, dataFile.location(), 0, 1);
    ...
    @Test
    void testReadEncryptedParquetTableWithEqualityDeletes()
            throws Exception
    {
    ...
    @Test
    void testPlaintextFileWithKeyMetadataFails()
            throws Exception
    {
    ...
    @Test
    void testPlaintextFileWithKeyMetadataAllowedBySessionProperty()
            throws Exception
    {
        Schema schemaWithString = new Schema(
                Types.NestedField.required(1, "id", Types.IntegerType.get()),
    ...
    @Test
    void testReadMixedEncryptedAndPlaintextFiles()
            throws Exception
    {
    ...
    @Test
    void testReadEncryptedAvroTableFails()
            throws Exception
    {
    ...
    // TODO Add test for ORC once Iceberg supports it: https://github.com/apache/iceberg/blob/187da3ed86e3226318d601828037d5d57c42a659/orc/src/main/java/org/apache/iceberg/orc/ORCFormatModel.java#L156-L166

    @Test
    void testWriteToEncryptedTableFails()
            throws Exception
    {
    ...
    @Test
    void testReadEncryptedTableChanges()
            throws Exception
    {
