...
public class TestIcebergConfig
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(IcebergConfig.class)
                ...
                .setPartitionStatisticsEnabled(true)
                .setPartitionStatisticsCollectOnWrite(false)
                .setProjectionPushdownEnabled(true)
                .setHiveCatalogName(null)
                .setFormatVersion(2)
                .setMaxFormatVersion(3)
                ...
                .setOptimizePartialTopNEnabled(true)
                .setUnsafeSortingPropertiesEnabled(false)
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = ImmutableMap.<String, String>builder()
                ...
                .put("iceberg.max-format-version", "2")
                ...
                .put("iceberg.optimize-partial-topn-enabled", "false")
                .put("iceberg.unsafe-sorting-properties-enabled", "true")
        ...
        IcebergConfig expected = new IcebergConfig()
                ...
                .setPartitionStatisticsEnabled(false)
                .setPartitionStatisticsCollectOnWrite(true)
                .setProjectionPushdownEnabled(false)
                .setHiveCatalogName("hive")
                .setFormatVersion(1)
                .setMaxFormatVersion(2)
                ...
                .setOptimizePartialTopNEnabled(false)
                .setUnsafeSortingPropertiesEnabled(true)
