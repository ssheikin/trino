        ...
        implements ConnectorFactory
{
    ...
    public TestingIcebergConnectorFactory(Optional<Module> icebergCatalogModule, Optional<FileIoProvider> fileIoProvider, Module module)
    {
    ...
    {
        return createConnector(catalogName, config, context, module, icebergCatalogModule, fileIoProvider);
    }
}
