        ...
        extends IcebergPlugin
{
    ...
    public TestingIcebergPlugin(Optional<Module> icebergCatalogModule, Optional<FileIoProvider> fileIoProvider, Module module)
    {
    ...
    public Iterable<ConnectorFactory> getConnectorFactories()
    {
        ...
        return ImmutableList.of(new TestingIcebergConnectorFactory(icebergCatalogModule, fileIoProvider, module));
    }
}
