        ...
        extends BaseIcebergConnectorSmokeTest
{
    ...
    public static final String AWS_ACCESS_KEY_ID = requireEnv("S3_TABLES_AWS_ACCESS_KEY_ID");
    public static final String AWS_SECRET_ACCESS_KEY = requireEnv("S3_TABLES_AWS_SECRET_ACCESS_KEY");
    public static final String AWS_REGION = requireEnv("S3_TABLES_AWS_REGION");
