        ...
        extends AbstractTestQueryFramework
{
            ...
            throws Exception
    {
        ...
        queryRunner.createCatalog(ICEBERG_CATALOG, "iceberg", Map.of(
                ...
                "iceberg.partition-statistics.enabled", "false",
    ...
    {
        testHighlyNestedFields(ImmutableMap.of());
        testHighlyNestedFields(ImmutableMap.of("write.merge.mode", "copy-on-write"));
        testHighlyNestedFields(ImmutableMap.of("format-version", "3"));
    }

    private void testHighlyNestedFields(Map<String, String> properties)
    {
