...
abstract class BaseGcsAndUnityMetastoreDeltaConnectorSmokeTest
        extends BaseUnityMetastoreDeltaConnectorSmokeTest
{
    private static final String DATABRICKS_UNITY_JDBC_URL = requireEnv("GCS_DATABRICKS_UNITY_JDBC_URL");
    private static final String DATABRICKS_HOST = requireEnv("GCS_DATABRICKS_HOST");
    private static final String DATABRICKS_LOGIN = requireEnv("GCS_DATABRICKS_LOGIN");
    private static final String DATABRICKS_TOKEN = requireEnv("GCS_DATABRICKS_TOKEN");
    private static final String DATABRICKS_UNITY_CATALOG_NAME = requireEnv("GCS_DATABRICKS_UNITY_CATALOG_NAME");
    private static final String DATABRICKS_UNITY_EXTERNAL_LOCATION = requireEnv("GCS_DATABRICKS_UNITY_EXTERNAL_LOCATION");
