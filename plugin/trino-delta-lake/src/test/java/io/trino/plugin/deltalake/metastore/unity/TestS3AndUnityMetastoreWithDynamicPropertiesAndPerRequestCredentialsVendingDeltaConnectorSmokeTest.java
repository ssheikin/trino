...
class TestS3AndUnityMetastoreWithDynamicPropertiesAndPerRequestCredentialsVendingDeltaConnectorSmokeTest
        extends BaseDynamicS3AndUnityMetastoreDeltaConnectorSmokeTest
{
    ...
    private Map<String, String> getDynamicProperties()
    {
        return ImmutableMap.<String, String>builder()
                ...
                .put("dynamic.hive-metastore-unity-vended-credentials-enabled.credential-name", "dynamic_vended_credentials")
                .buildOrThrow();
    }
    ...
    {
        // no extra storage credentials, using vending credentials
        return ImmutableMap.<String, String>builder()
                .put("dynamic_vended_credentials", "true")
                .buildOrThrow();
    }
