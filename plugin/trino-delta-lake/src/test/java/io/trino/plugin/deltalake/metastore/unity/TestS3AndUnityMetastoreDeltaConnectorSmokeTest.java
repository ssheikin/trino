...
{
    private static final Logger LOG = Logger.get(TestS3AndUnityMetastoreDeltaConnectorSmokeTest.class);
    private static final String SCHEMA_NAME = TPCH_SCHEMA + "_delta_ci_external";
            ...
            throws Exception
    {
        QueryRunner queryRunner = DeltaLakeQueryRunner.builder(SCHEMA_NAME)
                ...
                .addDeltaProperty("s3.aws-access-key", DATABRICKS_AWS_ACCESS_KEY_ID)
                .addDeltaProperty("s3.aws-secret-key", DATABRICKS_AWS_SECRET_ACCESS_KEY)
