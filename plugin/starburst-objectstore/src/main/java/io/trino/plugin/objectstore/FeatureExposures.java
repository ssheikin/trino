...
public final class FeatureExposures
{
    ...
    public Table<TableType, String, FeatureExposure> sessionExposureDecisions()
    {
        ...
        return builder
                ...
                .put(HIVE, "parquet_max_split_size", INACCESSIBLE)
                ...
                .put(HIVE, "parquet_writer_delta_length_byte_array_encoding_enabled", EXPOSED)
                .put(HIVE, "parquet_writer_page_size", EXPOSED)
                .put(HIVE, "parquet_writer_page_value_count", EXPOSED)
                .put(HIVE, "parquet_writer_row_group_max_row_count", EXPOSED)
                .put(HIVE, "parquet_writer_row_group_size", EXPOSED)
                ...
                .put(ICEBERG, "parquet_max_split_size", INACCESSIBLE)
                ...
                .put(ICEBERG, "parquet_writer_delta_length_byte_array_encoding_enabled", INACCESSIBLE)
                ...
                .put(ICEBERG, "remote_splits_generation_enabled", EXPOSED)
                .put(ICEBERG, "remote_splits_generation_manifests_per_thread", EXPOSED)
                ...
                .put(DELTA, "parquet_max_split_size", INACCESSIBLE)
                ...
                .put(DELTA, "parquet_writer_delta_length_byte_array_encoding_enabled", EXPOSED)
                .put(DELTA, "parquet_writer_page_size", EXPOSED)
                .put(DELTA, "parquet_writer_page_value_count", EXPOSED)
                .put(DELTA, "parquet_writer_row_group_max_row_count", EXPOSED)
                .put(DELTA, "parquet_writer_row_group_size", EXPOSED)
