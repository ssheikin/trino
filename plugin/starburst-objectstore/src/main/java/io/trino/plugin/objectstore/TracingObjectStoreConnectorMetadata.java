...
// due to SPI interface methods being deprecated & used here
@SuppressWarnings("deprecation")
public class TracingObjectStoreConnectorMetadata<T extends ConnectorMetadata>
        implements ConnectorMetadata
{
    ...
    public TracingObjectStoreConnectorMetadata(Tracer tracer, CatalogName catalogName, T delegate)
    {
        this.connectorClassName = delegate.getClass().getSimpleName();
