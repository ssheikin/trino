...
public class TestStarburstObjectStoreProperties
        extends BaseTestObjectStoreProperties
{
    public TestStarburstObjectStoreProperties(@TempDir Path metastoreDirectory)
    {
