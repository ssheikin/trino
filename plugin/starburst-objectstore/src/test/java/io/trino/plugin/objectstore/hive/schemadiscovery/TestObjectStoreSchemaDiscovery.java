        ...
        extends AbstractTestQueryFramework
{
    ...
    protected QueryRunner createQueryRunner()
            throws Exception
    {
        HiveMinioDataLake hiveMinioDataLake = closeAfterClass(new Hive3MinioDataLake(BUCKET_NAME));
        hiveMinioDataLake.start();
        FILES.forEach(path -> hiveMinioDataLake.getMinioClient().copyResourcePath(BUCKET_NAME, path, path));
