...
/**
 * Lakehouse substitution metadata. Lakehouse stores and substitutes materializations on Iceberg
 * only, so this delegates to the Iceberg connector's {@link ConnectorSubstitutionMetadata}. Handles
 * for the other table formats (Hive, Delta Lake, Hudi) are reported as non-substitutable rather than
 * routed, since those formats provide no substitution identity.
 */
        ...
        implements ConnectorSubstitutionMetadata
{
    ...
    public LakehouseSubstitutionMetadata(ConnectorSubstitutionMetadata icebergDelegate)
    {
