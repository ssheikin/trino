        ...
        extends AbstractTestQueryFramework
{
    ...
    public static Stream<Arguments> primitiveValidValues()
    {
        return ImmutableMap.<String, String>builder()
                ...
                .put("number_none_valid", "NUMBER '4.9E-325'")
                .put("integer_none_valid", "NUMBER '9223372036854775808'")
                .buildOrThrow()
                .entrySet()
                .stream()
    ...
    public static Stream<Arguments> outOfBoundNumbers()
    {
        return ImmutableMap.<String, Object>builder()
                ...
                .put("number_double_style_tooprecise", "Would lose floating point precision fitting decimal value in double type")
                .buildOrThrow()
                .entrySet()
                .stream()
                .map(entry -> Arguments.of(entry.getKey(), entry.getValue()));
