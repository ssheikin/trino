...
public class TestOpenApiWithLastElementCursorFieldPaginationServer
        extends AbstractTestQueryFramework
{
            ...
            throws Exception
    {
        ...
        return OpenApiQueryRunner.builder()
                .addConnectorProperties(ImmutableMap.<String, String>builder()
                        .put("openapi.description-location", "java_server/last_element_cursor_field_pagination.3.0.4.json")
    ...
    {
        assertThat(query("SELECT id, name FROM TABLE(openapi.default.items_after(per_page => 2))"))
                .matches(
                        """
                        VALUES
    ...
    @Test
    public void testLastElementFieldCursorRespectsLimit()
    {
        assertThat(query("SELECT id, name FROM TABLE(openapi.default.items_after(per_page => 2)) LIMIT 3"))
                .matches(
                        """
                        VALUES
                            (BIGINT '1', CAST('item-1' AS VARCHAR)),
    ...
    public void testExplicitCursorParameterDisablesPagination()
    {
        ...
        assertThat(query("SELECT * FROM TABLE(openapi.default.items_after(starting_after => '1', per_page => 3))"))
                .matches(
                        """
                        VALUES
                            (BIGINT '2', CAST('item-2' AS VARCHAR)),
    ...
    {
        // The /items/all endpoint has no starting_after/limit parameters in the description — the strategy's
    ...
    public static class PaginationServer
    {
                ...
                throws JsonProcessingException
        {
            ...
            return objectMapper.writeValueAsString(pageItems);
        }
