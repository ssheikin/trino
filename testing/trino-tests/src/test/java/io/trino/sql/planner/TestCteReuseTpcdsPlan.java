 ...
 * It uses Iceberg connector with partitioned TPC-DS tables.
 * <p>
 ...
 */
public class TestCteReuseTpcdsPlan
        extends BaseCostBasedPlanTest
{
    private static final String SCHEMA_NAME = "tpcds_sf1000_parquet_part";

    protected TestCteReuseTpcdsPlan()
    {
