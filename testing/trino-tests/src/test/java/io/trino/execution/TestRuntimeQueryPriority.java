...
public class TestRuntimeQueryPriority
{
            ...
            throws Exception
    {
        ...
        int numberOfLowPriorityQueries = 10;
        int numberOfNormalPriorityQueries = 10;
        ExecutorService executorService = Executors.newFixedThreadPool(numberOfLowPriorityQueries + numberOfNormalPriorityQueries);
        String query = "select count(*) from tpch.sf2.lineitem l where shipmode = 'MAIL'";
