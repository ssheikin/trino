...
public class TestQueuesDb
{
            ...
            throws Exception
    {
        ...
        dao.updateResourceGroup(3, "user-${USER}", "5MB", 3, 4, 4, null, null, null, null, null, null, 1L, TEST_ENVIRONMENT);
        dao.updateResourceGroup(5, "dashboard-${USER}", "5MB", 1, 2, 2, null, null, null, null, null, null, 3L, TEST_ENVIRONMENT);
            ...
            throws Exception
    {
        ...
        dao.insertResourceGroup(9, "reject-all-queries", "1MB", 0, 0, 0, null, null, null, null, null, null, 3L, TEST_ENVIRONMENT);
        ...
        dao.insertSelector(9, 200, "user.*", null, null, null, "(?i).*dashboard.*", null, null, null, null);
