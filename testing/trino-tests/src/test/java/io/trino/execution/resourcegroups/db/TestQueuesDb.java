...
public class TestQueuesDb
{
            ...
            throws InterruptedException
    {
        ...
        dao.insertSelector(10, 1, null, null, null, null, null, "[\"queued\"]", null);
        dao.insertResourceGroup(11, "running", "80%", 10, null, 2, null, null, null, null, null, null, TEST_ENVIRONMENT);
        dao.insertSelector(11, 1, null, null, null, null, null, "[\"running\"]", null);
        dbConfigurationManager.load();
        ...
        dao.insertSelector(12, 1, null, null, null, null, null, "[\"queued\"]", null);
        dao.deleteSelectors(11);
        dao.insertResourceGroup(13, "subgroup", "80%", 10, null, 1, null, null, null, null, null, 11L, TEST_ENVIRONMENT);
        dao.insertSelector(13, 1, null, null, null, null, null, "[\"running\"]", null);
        dbConfigurationManager.load();
            ...
            throws InterruptedException
    {
        ...
        dao.insertSelector(11, 1, null, null, null, null, null, "[\"queued\"]", null);
        ...
        dao.insertSelector(12, 1, null, null, null, null, null, "[\"running\"]", null);
        dbConfigurationManager.load();
            ...
            throws InterruptedException
    {
        ...
        dao.insertSelector(10, 1, null, null, null, null, null, "[\"tag\"]", null);
        dbConfigurationManager.load();
            ...
            throws InterruptedException
    {
        ...
        dao.insertSelector(10, 100, null, null, null, null, null, "[\"tag\"]", null);
        dbConfigurationManager.load();
        ...
        dao.insertSelector(11, 101, null, null, null, null, null, "[\"tag\"]", null);
        dbConfigurationManager.load();
