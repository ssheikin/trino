 ...
 */
public final class BenchmarkHiveTpchSf100
{
    private BenchmarkHiveTpchSf100() {}

    static void main(String[] args)
            throws Exception
    {
        System.exit(BenchmarkRunner.run(args, new TpchSf100Workload(), BenchmarkHiveTpchSf100.class));
    }
            ...
            extends BaseHiveTpchWorkload
    {
        ...
        public void validateDataLocation(String dataLocation)
        {
            ...
            String expected =
                    ...
                    """;
            BenchmarkRunner.verifyDataListing(Path.of(dataLocation), "Run `testing/benchmark-data/hydrate.sh hive-tpch-sf100` first.", expected);
        }
    }
}
