    ...
    public void testMetadataCalls()
    {
        ...
        assertMetadataCalls(
                ...
                ImmutableMultiset.<String>builder()
                        ...
                        .add("ConnectorMetadata.isMaterializedView(schema=test_schema1, table=test_table1)")
                        .add("ConnectorMetadata.isMaterializedView(schema=test_schema2, table=test_table1)")
                        .add("ConnectorMetadata.isMaterializedView(schema=test_schema3_empty, table=test_table1)")
                        .add("ConnectorMetadata.isMaterializedView(schema=test_schema4_empty, table=test_table1)")
        ...
        assertMetadataCalls(
                ...
                ImmutableMultiset.<String>builder()
                        ...
                        .add("ConnectorMetadata.isMaterializedView(schema=test_schema1, table=test_table1)")
                        .add("ConnectorMetadata.isMaterializedView(schema=test_schema1, table=test_table2)")
                        .add("ConnectorMetadata.isMaterializedView(schema=test_schema2, table=test_table2)")
                        .add("ConnectorMetadata.isMaterializedView(schema=test_schema2, table=test_table1)")
                        .add("ConnectorMetadata.isMaterializedView(schema=test_schema3_empty, table=test_table2)")
                        .add("ConnectorMetadata.isMaterializedView(schema=test_schema3_empty, table=test_table1)")
                        .add("ConnectorMetadata.isMaterializedView(schema=test_schema4_empty, table=test_table2)")
                        .add("ConnectorMetadata.isMaterializedView(schema=test_schema4_empty, table=test_table1)")
                        .add("ConnectorMetadata.isView(schema=test_schema1, table=test_table1)")
