        ...
        extends AbstractTestQueryFramework
{
    ...
    public void testJoinLargeBuildSideRangeDynamicFiltering()
    {
        ...
        DynamicFilterDomainStats domainStats = getOnlyElement(dynamicFiltersStats.getDynamicFilterDomainStats());
        assertThat(domainStats.getSimplifiedDomain()).isEqualTo("[ Bloom filter estimated cardinality: 15000, SortedRangeSet[type=bigint, ranges=1, {[1,60000]}], size: 2MB ]");
    }
    ...
    public void testSemiJoinLargeBuildSideRangeDynamicFiltering()
    {
        ...
        DynamicFilterDomainStats domainStats = getOnlyElement(dynamicFiltersStats.getDynamicFilterDomainStats());
        assertThat(domainStats.getSimplifiedDomain()).isEqualTo("[ Bloom filter estimated cardinality: 15002, SortedRangeSet[type=bigint, ranges=1, {[1,60000]}], size: 2MB ]");
    }
