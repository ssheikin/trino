...
public enum TestingConnectorBehavior
{
    ...
    SUPPORTS_CREATE_MATERIALIZED_VIEW_WHEN_STALE(SUPPORTS_CREATE_MATERIALIZED_VIEW),
    ...
    SUPPORTS_SET_DEFAULT_COLUMN_VALUE(SUPPORTS_DEFAULT_COLUMN_VALUE),
    SUPPORTS_DROP_DEFAULT_COLUMN_VALUE(SUPPORTS_DEFAULT_COLUMN_VALUE),
