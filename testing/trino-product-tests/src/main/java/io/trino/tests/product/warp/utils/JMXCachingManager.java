...
public class JMXCachingManager
{
            ...
            throws IllegalAccessException
    {
        ...
        mapBuilder.put(JMXCachingConstants.Columns.WARP_MATCH, "incorrect match - expected to match warp columns")
                .put(JMXCachingConstants.Columns.WARP_MATCH_ON_SIMPLIFIED_DOMAIN, "incorrect match - expected to match on simplified domain")
                .put(JMXCachingConstants.Columns.WARP_COLLECT, "incorrect collect - expected to collect warp columns")
                .put(JMXCachingConstants.Columns.WARP_MATCH_COLLECT, "incorrect collect - expected to match-collect warp columns")
                ...
                .put(JMXCachingConstants.DispatcherPageSource.WARP_SUCCESS, "incorrect cached warp success files - expected to go warp only")
