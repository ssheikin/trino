...
public class CompiledWithOssCustomType
        extends AbstractVariableWidthType
{
    public static final CompiledWithOssCustomType CUSTOM_TYPE = new CompiledWithOssCustomType();
    public static final String NAME = "mock_custom";
    ...
    private CompiledWithOssCustomType()
    {
        super(new TypeSignature(NAME, List.of()), Slice.class);
    }
