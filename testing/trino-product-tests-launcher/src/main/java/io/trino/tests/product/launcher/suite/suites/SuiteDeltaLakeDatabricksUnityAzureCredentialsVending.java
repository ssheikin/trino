...
import io.trino.tests.product.launcher.env.environment.EnvMultinodeDatabricksUnityAzureCredentialsVending;
...
public class SuiteDeltaLakeDatabricksUnityAzureCredentialsVending
        extends SuiteDeltaLakeDatabricks
{
    ...
    public List<SuiteTestRun> getTestRuns(EnvironmentConfig config)
    {
        return ImmutableList.of(
                testOnEnvironment(EnvMultinodeDatabricksUnityAzureCredentialsVending.class)
