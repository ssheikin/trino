...
import io.trino.tests.product.launcher.env.environment.EnvMultinodeDatabricksUnityGcsCredentialsVending;
...
public class SuiteDeltaLakeDatabricksUnityGcsCredentialsVending
