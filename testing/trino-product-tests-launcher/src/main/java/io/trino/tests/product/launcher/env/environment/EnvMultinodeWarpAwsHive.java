...
@TestsEnvironment
public final class EnvMultinodeWarpAwsHive
        extends MultinodeWarpGlueBase
{
    @Inject
    public EnvMultinodeWarpAwsHive(
            DockerFiles dockerFiles,
            PortBinder portBinder,
            StandardMultinode standardMultinode)
    {
        super("conf/environment/multinode-warp-aws-hive", dockerFiles, portBinder, standardMultinode);
    }
