...
public class TestConnectorExpressionJsonSubTypes
{
            ...
            throws IOException
    {
        ...
        Module module = ConnectorExpression.class.getModule();
        ModuleLayer layer = module.getLayer();
        checkState(layer != null, "%s must be loaded as a named module (run with the module path enabled), but was loaded from an unnamed module", ConnectorExpression.class);
        try (ModuleReader moduleReader = layer
                .configuration()
