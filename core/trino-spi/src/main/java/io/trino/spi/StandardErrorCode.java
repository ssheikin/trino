        ...
        implements ErrorCodeSupplier
{
    ...
    INVALID_FUNCTION_PROPERTY(133, USER_ERROR),
    BRANCH_NOT_FOUND(134, USER_ERROR),
    ...
    SUBQUERY_CACHE_MANAGER_NOT_CONFIGURED(65567, INTERNAL_ERROR),
    IR_ERROR(65568, INTERNAL_ERROR),

    REMOTE_SPLITS_GENERATION_ERROR(98304, INTERNAL_ERROR),
    REMOTE_SPLITS_TASK_MEMORY_UNAVAILABLE(98305, INSUFFICIENT_RESOURCES),
    REMOTE_SPLITS_TASK_QUEUE_FULL(98306, INSUFFICIENT_RESOURCES),
    ...
    EXCEEDED_LOCAL_GPU_MEMORY_LIMIT(131084, INSUFFICIENT_RESOURCES),
    EXCEEDED_LOCAL_OFF_HEAP_MEMORY_LIMIT(131085, INSUFFICIENT_RESOURCES),
