...
public class TestCharacterStringCasts
{
    ...
    public void testVarcharToCharSaturatedFloorCast()
    {
        ...
        // Trailing spaces are not representable in char(y): the floor replaces the last space with
        // the preceding code point and pads with the max code point up to y code points
        assertThat(varcharToCharSaturatedFloorCast(
                4L,
                utf8Slice("123 "))).isEqualTo(utf8Slice("123" + codePointBeforeSpace));
        assertThat(varcharToCharSaturatedFloorCast(
                4L,
        ...
        assertThat(varcharToCharSaturatedFloorCast(
                4L,
                utf8Slice("123 5"))).isEqualTo(utf8Slice("123" + codePointBeforeSpace));
    }
