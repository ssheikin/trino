...
public class TestOptimizerConfig
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(OptimizerConfig.class)
                ...
                .setApproximateRowCountForMetadataQueries(10_000L)
                ...
                .setForceSingleNodeQuery(false)
                .setAdaptivePartialAggregationEnabled(true)
                .setAdaptivePartialAggregationUniqueRowsRatioThreshold(0.8)
                .setCardinalityEstimationBasedPartialAggregationControllerEnabled(true)
                .setCardinalityEstimatorHllBucketCount(8192)
                .setAdaptivePartialAggregationLocalUniqueRowsRatioThreshold(0.01)
                ...
                .setPushPartialAggregationThroughExpandingJoin(true));
    }
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = ImmutableMap.<String, String>builder()
                ...
                .put("adaptive-partial-aggregation.cardinality-based-partial-aggregation-controller.enabled", "false")
                .put("adaptive-partial-aggregation.cardinality-based-partial-aggregation-controller.hll-bucket-count", "1024")
                .put("adaptive-partial-aggregation.local.unique-rows-ratio-threshold", "0.02")
                ...
                .put("optimizer.push-partial-aggregation-through-expanding-join", "false")
                .buildOrThrow();
        ...
        OptimizerConfig expected = new OptimizerConfig()
                ...
                .setForceSingleNodeQuery(true)
                .setAdaptivePartialAggregationEnabled(false)
                .setAdaptivePartialAggregationUniqueRowsRatioThreshold(0.99)
                .setCardinalityEstimationBasedPartialAggregationControllerEnabled(false)
                .setCardinalityEstimatorHllBucketCount(1024)
                .setAdaptivePartialAggregationLocalUniqueRowsRatioThreshold(0.02)
                ...
                .setPushPartialAggregationThroughExpandingJoin(false);
