        ...
        implements ConnectorFactory
{
    ...
    public static final class Builder
    {
        ...
        private ApplyPartialTopN applyPartialTopN = (_, _, _, _) -> Optional.empty();
        ...
        private Function<ConnectorTableHandle, Optional<CacheTableId>> getCacheTableId = _ -> Optional.empty();
        private Function<ColumnHandle, Optional<CacheColumnId>> getCacheColumnId = _ -> Optional.empty();
