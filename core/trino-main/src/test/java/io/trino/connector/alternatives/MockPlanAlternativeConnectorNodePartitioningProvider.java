...
public class MockPlanAlternativeConnectorNodePartitioningProvider
        implements ConnectorNodePartitioningProvider
{
    private final ConnectorNodePartitioningProvider delegate;

    public MockPlanAlternativeConnectorNodePartitioningProvider(ConnectorNodePartitioningProvider delegate)
    {
