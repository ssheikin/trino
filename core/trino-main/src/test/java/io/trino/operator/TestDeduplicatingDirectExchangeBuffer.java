...
public class TestDeduplicatingDirectExchangeBuffer
{
    ...
    {
        exchangeManagerRegistry = new ExchangeManagerRegistry(OpenTelemetry.noop(), TestingInternalNodeManager.createDefault().getTestingInternalCoordinatorLocator(), Tracing.noopTracer(), new SecretsResolver(ImmutableMap.of()));
    ...
    public void testExchangeManagerNotConfigured()
    {
        ...
        try (DirectExchangeBuffer buffer = new DeduplicatingDirectExchangeBuffer(
                ...
                RetryPolicy.QUERY,
                Optional.of(new ExchangeManagerRegistry(OpenTelemetry.noop(), TestingInternalNodeManager.createDefault().getTestingInternalCoordinatorLocator(), Tracing.noopTracer(), new SecretsResolver(ImmutableMap.of()))),
                new QueryId("query"),
                Span.getInvalid(),
