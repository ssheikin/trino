...
public class TestHashJoinOperator
{
    ...
    public void testInnerJoinWithNullableRunLengthEncodedAndDictionaryProbe()
    {
        ...
        RowPagesBuilder buildPages = rowPagesBuilder(ImmutableList.of(VARCHAR, BIGINT))
                ...
                .row("21", 2L)
                .row("21", 3L);
        BuildSideSetup buildSideSetup = setupBuildSide(partitionFunctionProvider, false, taskContext, buildPages, Ints.asList(0), Optional.empty(), true);
        JoinBridgeManager<PartitionedLookupSourceFactory> lookupSourceFactory = buildSideSetup.getLookupSourceFactoryManager();
        ...
        RowPagesBuilder probePagesBuilder = rowPagesBuilder(ImmutableList.of(VARCHAR, BIGINT))
                ...
                .addBlocksPage(
                        ...
                        createLongsBlock(62, 63));
        OperatorFactory joinOperatorFactory = innerJoinOperatorFactory(lookupSourceFactory, probePagesBuilder, Ints.asList(0), true);
    ...
    private void testInnerJoinWithMultiColumnBuildHash(boolean parallelBuild)
    {
        ...
        RowPagesBuilder buildPages = rowPagesBuilder(buildTypes)
                ...
                .pageBreak()
                .row("c", 3L);
        BuildSideSetup buildSideSetup = setupBuildSide(partitionFunctionProvider, parallelBuild, taskContext, buildPages, Ints.asList(0, 1), Optional.empty());
        JoinBridgeManager<PartitionedLookupSourceFactory> lookupSourceFactory = buildSideSetup.getLookupSourceFactoryManager();
        ...
        List<Page> probeInput = probePages
                ...
                .row("a", 2L)
                .build();
        OperatorFactory joinOperatorFactory = innerJoinOperatorFactory(lookupSourceFactory, probePages, Ints.asList(0, 1), false);
    ...
    private void testFullOuterJoinWithNonEmptyLookupSource(boolean parallelBuild, boolean singleBigintLookupSource)
    {
        ...
        RowPagesBuilder buildPages = rowPagesBuilder(buildTypes)
                ...
                .row(2L)
                .row(3L);
        BuildSideSetup buildSideSetup = setupBuildSide(partitionFunctionProvider, parallelBuild, taskContext, buildPages, Ints.asList(0), Optional.empty(), singleBigintLookupSource, true);
        JoinBridgeManager<PartitionedLookupSourceFactory> lookupSourceFactoryManager = buildSideSetup.getLookupSourceFactoryManager();
