...
public class TestPageProcessorCompiler
{
    ...
    public void testNoCaching()
    {
        ...
        PageProcessor pageProcessor = compiler.compilePageProcessor(Optional.empty(), projections, layout).get();
        PageProcessor pageProcessor2 = compiler.compilePageProcessor(Optional.empty(), projections, layout).get();
