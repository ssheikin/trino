...
public class TestMemoryTracking
{
    ...
    public void testLocalAllocations()
    {
        ...
        LocalMemoryContext pipelineLocalMemoryContext = pipelineContext.aggregateUserMemoryContext().newLocalMemoryContext("testLocalAllocations");
        ...
        assertLocalMemoryAllocations(
                ...
                1_000_000);
        LocalMemoryContext taskLocalMemoryContext = taskContext.getTaskMemoryContext().aggregateUserMemoryContext().newLocalMemoryContext("testLocalAllocations");
