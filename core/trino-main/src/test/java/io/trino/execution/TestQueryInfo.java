...
public class TestQueryInfo
{
    ...
    private static QueryInfo createQueryInfo(Optional<StagesInfo> stagesInfo)
    {
        return new QueryInfo(
                ...
                ImmutableSet.of(new Input(Optional.of("connectorName"), "catalog", new CatalogVersion("default"), "schema", "talble", Optional.empty(), ImmutableList.of(new Column("name", "type")), ImmutableMap.of("symbol", new Column("name", "type")), new PlanFragmentId("id"), new PlanNodeId("1"))),
                Optional.empty(),
                Optional.empty(),
                ImmutableList.of(),
                ImmutableList.of(),
