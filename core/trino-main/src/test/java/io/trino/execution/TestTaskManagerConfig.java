...
public class TestTaskManagerConfig
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(TaskManagerConfig.class)
                ...
                .setGpuExecutionEnabled(false)
                .setGpuLocalExchangeBufferSize(DataSize.of(48, Unit.MEGABYTE))
                .setMaxConcurrentFilesystemReads(Runtime.getRuntime().availableProcessors() * 2)
    ...
    public void testExplicitPropertyMappings()
    {
        ...
        Map<String, String> properties = ImmutableMap.<String, String>builder()
                ...
                .put("task.gpu-execution.enabled", "true")
                .put("task.gpu-local-exchange-buffer-size", "128MB")
                .put("task.max-concurrent-filesystem-reads", "32")
        ...
        TaskManagerConfig expected = new TaskManagerConfig()
                ...
                .setGpuExecutionEnabled(true)
                .setGpuLocalExchangeBufferSize(DataSize.of(128, Unit.MEGABYTE))
                .setMaxConcurrentFilesystemReads(32)
