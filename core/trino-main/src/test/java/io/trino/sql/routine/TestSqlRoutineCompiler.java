...
public class TestSqlRoutineCompiler
{
    ...
    private final SqlRoutineCompiler compiler = new SqlRoutineCompiler(PLANNER_CONTEXT.getFunctionManager(), PLANNER_CONTEXT.getMetadata(), PLANNER_CONTEXT.getTypeManager(), new CompilerConfig().getRowExpressionMaxMethodComplexity());
