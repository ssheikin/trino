...
final class TestLongBloomFilter
{
    ...
    void testContains()
    {
        ...
        assertThat(filter.getMaxDistinctHashes()).isEqualTo(1);
        filter.insert(-10);
        assertThat(filter.contains(-10)).isTrue();
        assertThat(filter.getMaxDistinctHashes()).isEqualTo(1);
        ...
        assertThat(filter.getMaxDistinctHashes()).isEqualTo(2);

        filter.insert(2342);
        assertThat(filter.contains(2342)).isTrue();
        assertThat(filter.getMaxDistinctHashes()).isEqualTo(3);

        filter.insert(Integer.MAX_VALUE);
        assertThat(filter.contains(Integer.MAX_VALUE)).isTrue();
        assertThat(filter.getMaxDistinctHashes()).isEqualTo(4);
        ...
        assertThat(filter.getMaxDistinctHashes()).isGreaterThanOrEqualTo(valuesCount / 10);
        assertThat(filter.isEmpty()).isFalse();
    ...
    void testMerge()
    {
        ...
        assertThat(bloomFilter1.getMaxDistinctHashes()).isEqualTo(3);
        assertThat(bloomFilter2.getMaxDistinctHashes()).isEqualTo(3);
        assertThat(bloomFilter1.contains(4L)).isFalse();
        assertThat(bloomFilter1.contains(5L)).isFalse();

        bloomFilter1.merge(bloomFilter2);

        assertThat(bloomFilter1.getMaxDistinctHashes()).isEqualTo(6);
        assertThat(bloomFilter2.getMaxDistinctHashes()).isEqualTo(3);
