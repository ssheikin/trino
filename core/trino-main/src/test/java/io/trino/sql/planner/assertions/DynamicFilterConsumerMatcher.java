        ...
        implements Matcher
{
            ...
            OptionalLong preferredTimeout)
    {
        public DynamicFilterConsumer
        {
            ...
            requireNonNull(preferredTimeout, "preferredTimeout is null");
        }
        ...
        public static class Builder
        {
            ...
            public Builder preferredTimeout(long preferredTimeout)
            {
                this.preferredTimeout = OptionalLong.of(preferredTimeout);
                return this;
            }

            public DynamicFilterConsumer build()
            {
                return new DynamicFilterConsumer(alias, operator, expression, nullAllowed, preferredTimeout);
            }
        }
    }
}
