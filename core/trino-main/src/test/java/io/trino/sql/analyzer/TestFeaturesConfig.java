...
public class TestFeaturesConfig
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(FeaturesConfig.class)
                ...
                .setAggregationOptimizedGroupByHashEnabled(true)
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = ImmutableMap.<String, String>builder()
                ...
                .put("aggregation.optimized-group-by-hash.enabled", "false")
                ...
                .put("exchange.adaptive-block-encoding-enabled", "false")
                ...
                .put("merge-partitioned-pages", "false")
                .put("max-recursion-depth", "8")
                .put("analyzer.max-grouping-sets", "2047")
                .put("gpu-acceleration.enabled", "true")
                .put("gpu-acceleration.table-scan-enabled", "true")
        ...
        FeaturesConfig expected = new FeaturesConfig()
                ...
                .setAggregationOptimizedGroupByHashEnabled(false)
                ...
                .setMergePartitionedPages(false)
                .setMaxRecursionDepth(8)
                .setMaxGroupingSets(2047)
                .setGpuAccelerationEnabled(true)
                .setGpuTableScanEnabled(true)
