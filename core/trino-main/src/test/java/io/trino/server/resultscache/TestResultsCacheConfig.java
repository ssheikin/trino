...
public class TestResultsCacheConfig
{
    @Test
    public void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(ResultsCacheConfig.class)
                .setCacheUploadThreads(5)
                .setMaxResultsSize(DataSize.of(1, MEGABYTE)));
    }
