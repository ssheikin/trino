...
public class TestArrowLz4EncodingDecoding
        extends AbstractTestEncodingDecoding
{
    ...
    {
        return new ArrowQueryDataEncoder(allocator, new ArrowCompressionFactory(), CompressionUtil.CodecType.LZ4_FRAME, columns, DataSize.of(32, DataSize.Unit.MEGABYTE).toBytes());
    }
