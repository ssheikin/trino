        ...
        implements GpuAggregateFunction
{
    ...
    public GpuCountNonNull(int inputChannel, Type outputType, DType outputDType)
    {
    ...
    {
        long nonNullCount = column.getRowCount() - column.getNullCount();
        return Scalar.fromLong(nonNullCount);
    }
    ...
    {
        return GroupByAggregation.count(NullPolicy.EXCLUDE);
    }
