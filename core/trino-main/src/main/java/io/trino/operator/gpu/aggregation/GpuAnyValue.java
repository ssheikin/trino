        ...
        implements GpuAggregateFunction
{
    ...
    public GpuAnyValue(int inputChannel, Type outputType, DType outputDType)
    {
    ...
    {
        return column.reduce(ReductionAggregation.nth(0, NullPolicy.EXCLUDE), outputDType);
    }

    @Override
    public GroupByAggregation groupByAggregation()
    {
        return GroupByAggregation.nth(0, NullPolicy.EXCLUDE);
    }
