        ...
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        ...
        binder.bind(JoinPagesIndex.Factory.class).to(JoinPagesIndex.DefaultFactory.class);
        ...
        jsonCodecBinder(binder).bindJsonCodec(ConstantValue.class);
        jsonCodecBinder(binder).bindJsonCodec(new TypeLiteral<ConstantValue[]>() {});
