...
import io.airlift.compress.v3.lz4.Lz4FrameCompressor;
        ...
        extends AbstractCompressionCodec
{
    ...
    {
        Lz4FrameCompressor compressor = Lz4FrameCompressor.create();
        ...
        try {
            ...
            throw new RuntimeException("Error compressing to LZ4 frame", e);
        }
    }
    ...
    {
        throw new UnsupportedOperationException("Decompression is not supported on the server side");
    }
