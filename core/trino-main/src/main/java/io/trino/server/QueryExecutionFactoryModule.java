        ...
        implements Module
{
    ...
    public void configure(Binder binder)
    {
        ...
        bindDataDefinitionTask(binder, executionBinder, CreateBranch.class, CreateBranchTask.class);
        ...
        bindDataDefinitionTask(binder, executionBinder, DropBranch.class, DropBranchTask.class);
        ...
        bindDataDefinitionTask(binder, executionBinder, FastForwardBranch.class, FastForwardBranchTask.class);
        ...
        bindDataDefinitionTask(binder, executionBinder, RenameCatalog.class, RenameCatalogTask.class);
        ...
        bindDataDefinitionTask(binder, executionBinder, SetCatalogProperties.class, SetCatalogPropertiesTask.class);
