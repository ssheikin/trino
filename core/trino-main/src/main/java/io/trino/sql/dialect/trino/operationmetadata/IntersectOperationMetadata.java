...
public class IntersectOperationMetadata
        implements TrinoOperationMetadata
{
    ...
    {
        checkArgument(!arguments.isEmpty(), "Intersect operation must have at least one argument: an input relation");
        checkArgument(arguments.size() == regions.size(), "Intersect operation must have one region per input relation");
    ...
    {
        return IntersectOperationMetadata::deriveAttributes;
    }
