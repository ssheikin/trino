...
public class NodePartitionMap
{
    ...
    public record BucketToPartition(int[] bucketToPartition, boolean hasFixedMapping)
    {
        ...
        public boolean equals(Object o)
        {
            ...
            BucketToPartition that = (BucketToPartition) o;
            return hasFixedMapping == that.hasFixedMapping
                    && Objects.deepEquals(bucketToPartition, that.bucketToPartition);
        }

        @Override
        public int hashCode()
        {
            return Objects.hash(Arrays.hashCode(bucketToPartition), hasFixedMapping);
        }
    }
