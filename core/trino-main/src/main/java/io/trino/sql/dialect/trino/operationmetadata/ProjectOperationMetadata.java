        ...
        implements TrinoOperationMetadata
{
    ...
    {
        checkArgument(arguments.size() == 1, "Project operation must have exactly one argument: the input relation");
        checkArgument(regions.size() == 1, "Project operation must have exactly one region: the assignments");
    ...
    {
        return ProjectOperationMetadata::deriveAttributes;
    }
    ...
    {
        checkArgument(childAttributes.size() == 2, "Project operation must have exactly two child attributes maps: one for the input, and one for the assignments");
