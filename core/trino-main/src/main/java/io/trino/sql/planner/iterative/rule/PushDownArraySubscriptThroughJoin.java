 ...
 * </pre>
 * <p>
 * Pushes down array subscript projections through JoinNode. Excludes array subscript on symbols being used in join criteria to avoid
 * data replication, since these symbols cannot be pruned.
 */
public class PushDownArraySubscriptThroughJoin
        implements Rule<ProjectNode>
{
    ...
    public Result apply(ProjectNode projectNode, Captures captures, Context context)
    {
        ...
        arraySubscripts = arraySubscripts.stream()
                .filter(expression -> !excludeSymbols.contains(getArrayBase(expression)))
