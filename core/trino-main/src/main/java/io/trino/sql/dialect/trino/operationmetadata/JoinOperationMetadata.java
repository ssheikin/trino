        ...
        implements TrinoOperationMetadata
{
    ...
    public Operation createOperation(String resultName, List<Value> arguments, List<Region> regions, Map<AttributeKey, Object> attributes)
    {
        ...
        return new Join(
                ...
                arguments.get(0),
                arguments.get(1),
                regions.get(0).getOnlyBlock().withLabel("^leftCriteriaSelector"),
                regions.get(1).getOnlyBlock().withLabel("^rightCriteriaSelector"),
                regions.get(2).getOnlyBlock().withLabel("^filter"),
                regions.get(3).getOnlyBlock().withLabel("^leftOutputSelector"),
                regions.get(4).getOnlyBlock().withLabel("^rightOutputSelector"),
                regions.get(5).getOnlyBlock().withLabel("^dynamicFilterTargetSelector"),
