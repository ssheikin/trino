        ...
        extends TrinoOperation
{
    ...
    public Intersect(String resultName, List<Value> inputs, List<Block> inputFieldSelectors, boolean distinct, List<Attributes> sourceAttributes)
    {
        this(resultName, inputs, inputFieldSelectors, distinct, sourceAttributes, Attributes.empty());
    }

    public Intersect(String resultName, List<Value> inputs, List<Block> inputFieldSelectors, boolean distinct, List<Attributes> sourceAttributes, Attributes enforcedAttributes)
    {
        super(TRINO, NAME);
