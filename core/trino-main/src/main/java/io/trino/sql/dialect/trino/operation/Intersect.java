...
import static io.trino.sql.dialect.trino.operationmetadata.IntersectOperationMetadata.DISTINCT;
import static io.trino.sql.dialect.trino.operationmetadata.IntersectOperationMetadata.NAME;
        ...
        extends TrinoOperation
{
    ...
    public Intersect(String resultName, List<Value> inputs, List<Block> inputFieldSelectors, boolean distinct, List<Map<AttributeKey, Object>> sourceAttributes)
    {
        this(resultName, inputs, inputFieldSelectors, distinct, sourceAttributes, ImmutableMap.of());
    }

    public Intersect(String resultName, List<Value> inputs, List<Block> inputFieldSelectors, boolean distinct, List<Map<AttributeKey, Object>> sourceAttributes, Map<AttributeKey, Object> enforcedAttributes)
    {
        super(TRINO, NAME);
        ...
        validateSetOperation(inputs, inputFieldSelectors, sourceAttributes, "Intersect");
        ...
        attributes.putAll(IntersectOperationMetadata.deriveAttributes(operationAttributes, childAttributes.build()));
    ...
    {
        return filterAttributes(IntersectOperationMetadata.OPERATION_ATTRIBUTES);
    }
