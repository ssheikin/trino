...
public final class LambdaBytecodeGenerator
{
            ...
            int maxMethodComplexity)
    {
        ...
        ExpressionBytecodeCompiler innerExpressionCompiler = new ExpressionBytecodeCompiler(
                ...
                callSiteBinder,
                cachedInstanceBinder,
                lambdaParameterReferenceCompiler(parameterMap),
                functionManager,
                metadata,
                typeManager,
                maxMethodComplexity,
            ...
            Class<?> lambdaInterface)
    {
        ...
        List<BytecodeExpression> captureVariables = ImmutableList.<BytecodeExpression>builder()
                .add(context.getExpressionCompiler().mainReference(), scope.getVariable("session"))
    ...
    public static Class<? extends Supplier<Object>> compileLambdaProvider(Lambda lambdaExpression, FunctionManager functionManager, Metadata metadata, TypeManager typeManager, int maxMethodComplexity, Class<?> lambdaInterface)
    {
