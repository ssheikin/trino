...
public final class SqlBatchFunction
        implements SqlFunction
{
    private final FunctionMetadata functionMetadata;
    private final MethodHandle handle;

    public SqlBatchFunction(FunctionMetadata functionMetadata, MethodHandle handle)
    {
    ...
    BatchFunctionImplementation getBatchFunctionImplementation()
    {
