...
{
    public static final BlockEncodingSerde TESTING_BLOCK_ENCODING_SERDE = new InternalBlockEncodingSerde(new BlockEncodingManager(new FeaturesConfig(), new BlockEncodingSimdSupport(true)), TESTING_TYPE_MANAGER);
