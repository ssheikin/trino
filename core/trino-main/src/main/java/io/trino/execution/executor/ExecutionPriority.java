...
public class ExecutionPriority
{
    ...
    /**
     * Normal to a low-priority queries resource usage ratio.
     * For example, 1 means both use the same amount of resources.
     * 100 means normal queries should use 100 times more resources than low-priority queries.
     */
    private final double normalPriorityResourceUsageMultiplier;

    public ExecutionPriority(double normalPriorityResourceUsageMultiplier)
    {
        ...
        this.normalPriorityResourceUsageMultiplier = normalPriorityResourceUsageMultiplier;
    }
     ...
     * if the cluster is close to 100% CPU utilization and there are higher priority queries running.
     */
    ...
    {
        return "ExecutionPriority(" + normalPriorityResourceUsageMultiplier + ")";
    }
}
