        ...
        extends Statement
{
    ...
    public SetCatalogProperties(Identifier name, List<Property> properties)
    {
        this(Optional.empty(), name, properties);
    }

    public SetCatalogProperties(NodeLocation location, Identifier name, List<Property> properties)
    {
        this(Optional.of(location), name, properties);
    }

    private SetCatalogProperties(Optional<NodeLocation> location, Identifier name, List<Property> properties)
    {
        super(location);
