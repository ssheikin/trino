        ...
        return (
            <div className="row">
                <div className="col-xs-12">
                    ...
                    {this.state.selectedStatistics.map(
                        function (statistic) {
                            return (
                                <OperatorStatistic
                                    key={statistic.id}
...
class StageOperatorGraph extends React.Component {
    ...
    handleOperatorClick(operatorCssId) {
        ...
        ReactDOM.render(
            <OperatorDetail key={operatorCssId} operator={operatorStageSummary} tasks={stage.tasks} />,
    ...
    computeD3StageOperatorGraph(graph, operator, sink, pipelineNode) {
        const operatorNodeId =
            'operator-' + operator.pipelineId + '-' + operator.operatorId + '-' + operator.alternativeId
    ...
    render() {
        ...
        if (
            !stage.hasOwnProperty('stageStats') ||
            !stage.stageStats.hasOwnProperty('operatorSummaries') ||
            stage.stageStats.operatorSummaries.length === 0
        ) {
            return (
                <div className="row error-message">
                    <div className="col-xs-12">
    ...
    render() {
        ...
        return (
            <div>
                ...
                <hr className="h3-hr" />
                <div className="row">
                    <div className="col-xs-12">{stageOperatorGraph}</div>
                </div>
            </div>
        )
    }
