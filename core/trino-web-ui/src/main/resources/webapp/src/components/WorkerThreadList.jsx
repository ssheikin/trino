    ...
    renderGroupListItem(group) {
        return (
            <li key={group}>
                <a
                    href="#"
                    className={this.state.selectedGroup === group ? 'selected' : ''}
    ...
    renderThreadStateListItem(threadState) {
        return (
            <li key={threadState}>
                <a
                    href="#"
                    className={this.state.selectedThreadState === threadState ? 'selected' : ''}
        ...
        if (threads === null) {
            if (this.state.initialized === false) {
                ...
                display = (
                    <div className="row error-message">
                        <div className="col-xs-12">
                            <h4>Thread snapshot could not be loaded</h4>
                        </div>
                    </div>
                )
            }
            ...
            if (filteredThreads.length === 0 && this.state.selectedThreadState === ALL_THREAD_STATE) {
                ...
                displayedThreads = <pre>{filteredThreads.map((t) => this.renderThread(t))}</pre>
            }
