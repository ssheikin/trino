...
import static io.trino.client.spooling.encoding.DecompressionUtils.decompressLz4Frame;
import static java.lang.Math.toIntExact;
import static java.lang.String.format;
import static org.apache.arrow.vector.compression.CompressionUtil.CodecType.LZ4_FRAME;

public class AirliftLz4CompressionCodec
        extends AbstractCompressionCodec
{
    ...
    protected ArrowBuf doDecompress(BufferAllocator allocator, ArrowBuf compressedBuffer)
    {
        ...
        try {
            ...
            long actualUncompressedLength = decompressLz4Frame(inputBuffer, outputBuffer);
