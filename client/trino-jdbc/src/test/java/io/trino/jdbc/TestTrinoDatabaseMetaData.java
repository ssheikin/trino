        ...
        try (Connection connection = createConnection()) {
            ...
            assertMetadataCalls(
                    ...
                    ImmutableMultiset.<String>builder()
                            ...
                            .addCopies("ConnectorMetadata.isMaterializedView(schema=test_schema1, table=test_table1)", 4)
                            .addCopies("ConnectorMetadata.getMaterializedView(schema=test_schema1, table=test_table1)", 1)
                            ...
                            .addCopies("ConnectorMetadata.isMaterializedView(schema=test_schema2, table=test_table1)", 4)
                            .addCopies("ConnectorMetadata.getMaterializedView(schema=test_schema2, table=test_table1)", 1)
