...
public abstract class BaseTrinoDriverTest
{
    ...
    protected abstract Connection createConnection(String catalog)
            throws SQLException;

    protected abstract Connection createConnection(String catalog, String schema)
            throws SQLException;

    protected abstract Connection createConnectionWithParameter(String parameter)
            throws SQLException;
    ...
    protected static String driverPropertyInfoToString(DriverPropertyInfo info)
    {
