...
public class TestKafkaWithConfluentSchemaRegistryMinimalFunctionality
{
    ...
    @Test
    @Flaky(issue = "https://github.com/prestosqldb/prestosql/issues/6412", match = "Error registering Avro schema: .*")
    ...
    @Test
    @Flaky(issue = "https://github.com/prestosqldb/prestosql/issues/6412", match = "Error registering JSON schema: .*")
